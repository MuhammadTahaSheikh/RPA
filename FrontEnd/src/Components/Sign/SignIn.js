...
import "./SignIn.css";
import email_icon from "../../Assets/brain.svg";
import password_icon from "../../Assets/brain.svg";
import eye_icon from "../../Assets/arrow_up.svg";
import non_seen_eye_icon from "../../Assets/brain.svg";
...
function SignIn() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      if (
        email === "blog-admin@stopshoprei.com" &&
        password === "Password12@"
      ) {
